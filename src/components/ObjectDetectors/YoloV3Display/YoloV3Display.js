...
const YoloV3TinyDisplay = ({ stream, canvasRef, isLoading, setIsLoading, modelContent, setmodelContent }) => { // Agregar isLoading y setIsLoading como props
...
export default YoloV3TinyDisplay;